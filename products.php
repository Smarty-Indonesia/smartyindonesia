        ...
        <div class="product-item-title d-flex">
          <div class="bg-faded p-5 d-flex ml-auto rounded">
            <h2 class="section-heading mb-0">
              <span class="section-heading-upper">Crypto Currency</span>
              <span class="section-heading-lower"><a href="https://spy-token.io" target="_blank">Smarty Pay Token</a></span>
            </h2>
          </div>
        </div>
      ...
      <div class="product-item">
        <div class="product-item-title d-flex">
          <div class="bg-faded p-5 d-flex ml-auto rounded">
            <h2 class="section-heading mb-0">
              <span class="section-heading-upper">Crypto Currency</span>
              <span class="section-heading-lower"><a href="http://smarty.tokie.id" target="_blank">Mini Tokie</a></span>
            </h2>
          </div>
        </div>
      ...
      <div class="product-item">
        <div class="product-item-title d-flex">
          <div class="bg-faded p-5 d-flex mr-auto rounded">
            <h2 class="section-heading mb-0">
              <span class="section-heading-upper">Matrix - Hybrid - Blockchain</span>
              <span class="section-heading-lower"><a href="http://nemot.smartyind.com/" target="_blank">NEMOT</a></span>
            </h2>
          </div>
        </div>
    ...
    <div class="container">
      <div class="product-item">
        <div class="product-item-title d-flex">
          <div class="bg-faded p-5 d-flex ml-auto rounded">
            <h2 class="section-heading mb-0">
              <span class="section-heading-upper">Point of Sales</span>
              <span class="section-heading-lower"><a href="http://kasir.smartyseller.id/" target="_blank">Smarty POS Umum</a></span>
            </h2>
          </div>
        </div>
